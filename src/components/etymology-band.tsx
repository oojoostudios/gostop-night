        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-16 py-10 sm:py-12">
          ...
          >
            ...
            >
              ...
              <span className="text-foreground/30 text-base">→</span>
              <span className="not-italic text-rose-700 dark:text-rose-400">
                화투
              </span>
            </div>
              ...
              <p className="text-sm sm:text-base text-foreground/75 leading-relaxed">
                {locale === "ko" ? (
                  <>
                    ...
                    <em className="not-italic font-medium text-foreground/90">
                      카루타(carta)
                    </em>
                    가 에도 막부의 도박 금지령을 피해{" "}
                    <em className="not-italic font-medium text-foreground/90">
                    ...
                    라는 꽃 그림 카드로 변형됐고, 19세기 말 대마도 상인들을 통해
                    한국으로 유입된 것으로 전해집니다.
                  </>
                ) : (
                  <>
                    In the late 16th century, Portuguese missionaries brought
                    playing cards called{" "}
                    <em className="not-italic font-medium text-foreground/90">
                      carta
                    </em>{" "}
                    to Japan. To skirt the Edo shogunate&apos;s gambling bans,
                    they mutated into floral picture cards called{" "}
                    <em className="not-italic font-medium text-foreground/90">
                      hanafuda (花札)
                    </em>
                    , and entered Korea via Tsushima merchants in the late 19th
                    century — eventually becoming{" "}
                    <em className="not-italic font-medium text-foreground/90">
                      hwatu (화투)
                    </em>
                    .
