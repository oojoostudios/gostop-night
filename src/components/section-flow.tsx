...
const TTADAK_STEPS: Step[] = [
  {
    ...
    desc: 'The floor already shows two January pi cards (left over from earlier turns). You happen to be holding the January bright.',
    descKo: '이전 차례들의 결과로 바닥엔 1월 피 2장이 있어요. 마침 내 손엔 1월 광이 들려있고요.',
    state: {
  ...
  },
  {
    ...
    titleKo: '한 번에 3장',
    desc: 'When you play your January bright, it matches both floor cards. All three go into your taken pile.',
    descKo: '1월 광을 내면 바닥의 1월 두 장과 한꺼번에 매치돼요. 세 장 모두 내 먹은 패로.',
    state: {
  ...
  },
  {
    ...
    desc: "You still flip the deck card afterwards. May pi doesn't match anything on the floor — it just sits down. But the ttadak already earned you bonus pi from each opponent.",
    descKo:
...
const PPEOK_STEPS: Step[] = [
  ...
  },
  {
    ...
    desc: 'All three January cards now stay on the floor — nobody takes them. The next player who plays a January card will sweep all four (the locked three plus their own).',
    descKo:
...
const SWEEP_STEPS: Step[] = [
  {
    ...
    desc: "Several turns in. Most floor cards have been taken throughout the round. Just a single January pi remains — and you're holding the January bright.",
    descKo:
  ...
  },
  {
    ...
    desc: "Your January bright takes the lone January pi. The floor is now empty — that's 싹쓸이 (sweep). Every opponent gives you one pi.",
    descKo:
  ...
  },
  {
    ...
    desc: 'After the sweep you still flip from the deck. May pi has nothing to match — it sits down on the (briefly empty) floor.',
    descKo:
...
const POKDAN_STEPS: Step[] = [
  {
    ...
    desc: "You're holding three January cards (bright + ribbon + pi). The fourth — a January piece — is sitting on the floor. Bomb condition.",
    descKo:
  ...
  },
  {
    ...
    desc: 'Instead of one card per turn, you slam all three same-month cards down at once and sweep the floor card too. All four January cards into your taken pile.',
    descKo:
  ...
  },
  {
    ...
    desc: "You still flip a card afterwards. May pi doesn't match — it joins the floor. The pokdan already earned you one pi from each opponent.",
    descKo:
...
const SELFPPEOK_STEPS: Step[] = [
  {
    ...
    desc: 'You hold the January bright. The floor has no January — same starting point as 쪽 (jjok). Played card will land on the floor with no match.',
    descKo:
  ...
  },
  {
    ...
    titleKo: '더미도 1월 — 자뻑!',
    desc: "Now you flip the deck card and it's another January. Both came from YOU this turn (your hand-play + your own flip). That's 자뻑 (self-ppeok).",
    descKo:
  ...
  },
  {
    ...
    desc: "Since both January cards came from your own actions, you take them — but unlike 쪽, you don't get bonus pi from each opponent. (Some house rules treat 자뻑 as locked floor instead — check your group's variant.)",
    descKo:
