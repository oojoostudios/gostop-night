...
const SCENARIOS: ReadonlyArray<Scenario> = [
  {
    ...
    setupKo: '방금 7점 달성. 상대 둘 다 점수가 낮고, 더미도 거의 다 떨어졌어요.',
    facts: [
  ...
  },
  {
    ...
    setupKo: '광 2장으로 7점 달성. 바닥에 또 다른 광이 보이고, 더미도 충분히 남아있어요.',
    facts: [
      { label: 'Your score', labelKo: '내 점수', value: '7' },
  ...
  },
  {
    ...
    setupKo: '내가 7점인데, 한 상대가 6점에 광 2장으로 광을 노리고 있어요. 여기서 고는 위험해요.',
    facts: [
      { label: 'Your score', labelKo: '내 점수', value: '7' },
