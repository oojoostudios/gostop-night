...
const HIGHLIGHTS: ReadonlyArray<{
  ...
  },
  {
    ...
    descKo:
      "출발에서 시계 반대 방향으로 외곽을 한 바퀴 돌면 20칸. 화살표 방향으로 진행해요.",
    descEn:
      "From start, the outer loop counterclockwise takes 20 stations. Follow the arrows.",
  },
  {
    id: "shortcut",
    labelKo: "지름길",
  ...
  },
  {
    ...
    descKo:
      "4개 코너 (출발 + 첫모/둘모/셋모) — 지름길 진입 지점이에요.",
    descEn:
          ...
          <div className="space-y-1.5">
            {HIGHLIGHTS.map((h) => {
              ...
              return (
                ...
                >
                  <span className={isActive ? "" : "text-foreground/50"}>
                    {h.icon}
                  </span>
