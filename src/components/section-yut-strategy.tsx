...
const T_GEOL = THROWS.find((t) => t.id === "geol")!;
...
const CATCH_STEPS: Step[] = [
  {
    ...
    desc:
      "P2's blue piece is parked on o-r3, three spaces from start. P1's red piece is one step behind on o-r4.",
    descKo:
      "P2 파란 말이 o-r3(출발에서 3칸)에 있어요. P1 빨간 말은 한 칸 뒤 o-r4에.",
    state: {
      pieces: [
  ...
  },
  {
    ...
    titleKo: "P1이 던져서 — 도 (1)",
    desc:
      "P1 needs exactly 1 to land where P2 is. Lucky throw — do!",
    descKo:
      "P2가 있는 칸까지 정확히 1칸. 운 좋게 도가 나왔어요.",
    state: {
      pieces: [
        { id: "p1", history: ["o-r4"], player: "p1" },
        { id: "p2", history: ["o-r4", "o-r3"], player: "p2" },
  ...
  },
  {
    ...
    desc:
      "P1 moves to o-r3, landing exactly where P2 is. That's a catch (잡기). P2 is sent back to start, and P1 gets a bonus throw.",
    descKo:
...
const STACK_STEPS: Step[] = [
  ...
  },
  {
    ...
    titleKo: "P1이 던져서 — 윷 (4)",
    desc:
      "Yut! Move 4 + bonus throw. P1 plans to advance B 4 spaces — exactly to A's spot.",
    descKo:
      "윷! 4칸 + 보너스. P1은 B를 4칸 전진시키기로 — 마침 A 자리예요.",
    state: {
      pieces: [
        { id: "a", history: ["o-r4", "o-r3", "o-r2", "o-r1"], player: "p1" },
        { id: "b", history: [], player: "p1" },
  ...
  },
  {
    ...
    desc:
      "Piece B hops 4 stations and arrives at o-r1, the exact spot where A is. Two same-color pieces sharing one station.",
    descKo:
      "B가 4칸 hop hop 해서 A가 있는 o-r1에 도착. 같은 색 말 두 개가 한 자리에.",
    state: {
      pieces: [
        { id: "a", history: ["o-r4", "o-r3", "o-r2", "o-r1"], player: "p1" },
  ...
  },
  {
    ...
    desc:
      "P1 stacks A and B into a single ×2 piece. From now on they travel together — moved as one but counted as two when they reach home.",
    descKo:
      "P1이 A와 B를 업어서 ×2 한 덩어리로. 이동은 한 번에, 골인은 둘 다 인정.",
    state: {
      pieces: [
        {
          id: "a",
  ...
  },
  {
    ...
    desc:
      "P1's bonus throw is geol (3). The stacked piece advances 3 — both pieces moved at the same cost.",
    descKo:
      "보너스 던지기는 걸 (3). 업힌 말이 한꺼번에 3칸 — 두 말이 한 번에 이동.",
    state: {
      pieces: [
        {
          id: "a",
...
const RISK_STEPS: Step[] = [
  {
    ...
    desc:
      "P1 has a ×2 stack at o-r1 from a previous turn. P2 is at start, hungry to catch.",
    descKo:
      "P1의 ×2 업힌 말이 지난 차례 결과로 o-r1에 있어요. 출발점의 P2가 기회를 노려요.",
    state: {
      pieces: [
        {
          id: "stack",
  ...
  },
  {
    ...
    titleKo: "P2가 던져서 — 윷 (4)",
    desc:
      "P2 rolls yut — exactly the distance from start to o-r1. A devastating roll for P1.",
    descKo:
      "P2가 윷 — 출발점에서 o-r1까지 정확히 4칸. P1에겐 최악의 결과예요.",
    state: {
      pieces: [
        {
          id: "stack",
  ...
  },
  {
    ...
    desc:
      "P2's piece advances 4 stations and lands right where P1's stack sits. Both colors are momentarily on o-r1.",
    descKo:
      "P2가 4칸 전진해서 P1의 ×2가 있는 자리에 도착. 두 색이 잠깐 o-r1에 함께 있어요.",
    state: {
      pieces: [
        {
          id: "stack",
  ...
  },
  {
    ...
    desc:
      "When a stack is caught, ALL pieces in it return to start at once. The risk of stacking — P2 also earns a bonus throw.",
    descKo:
...
const SCENARIOS: ReadonlyArray<Scenario> = [
  ...
  },
  {
    ...
    blurb:
      "Stacking concentrates risk: if the stack gets caught, ALL pieces go home at once.",
    blurbKo:
      "업기엔 위험도 따라요. 업힌 말이 잡히면 그 안의 말 모두가 한꺼번에 출발점으로.",
    steps: RISK_STEPS,
  },
];
