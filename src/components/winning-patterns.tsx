...
const PATTERNS: ReadonlyArray<Pattern> = [
  {
    ...
    points: SCORING.brights.five,
    accent: 'gold',
    desc: `All five bright (광) cards. The highest single combo in standard go-stop — collect the entire bright set and you score ${SCORING.brights.five} in one go.`,
    descKo:
  ...
  },
  {
    ...
    points: SCORING.brights.four,
    accent: 'gold',
    desc: `Any four bright (광) cards. Unlike at the three-bright threshold, the Rain bright (비광) doesn't penalize at four brights — it's always ${SCORING.brights.four} points.`,
    descKo: `광 4장. 3광에서는 비광이 끼면 점수가 내려가지만, 4광에서는 비광이 들어가도 그대로 ${SCORING.brights.four}점.`,
    cardIds: ['01-gwang', '03-gwang', '08-gwang', '11-gwang'],
    note: `Rain bright (비광) included is still ${SCORING.brights.four} points.`,
    noteKo: `비광 포함 4광도 ${SCORING.brights.four}점.`,
  },
  {
    id: '3gwang',
    labelKo: '3광',
    englishName: 'Three Brights',
    points: SCORING.brights.three,
    accent: 'gold',
    desc: `Any three bright (광) cards. Without the Rain bright it's ${SCORING.brights.three} points. With it, the score drops to ${SCORING.brights.threeWithRain} — a quirk that makes 비광 a tricky card to chase.`,
    descKo: `광 3장. 비광 없이는 ${SCORING.brights.three}점, 비광이 끼면 ${SCORING.brights.threeWithRain}점으로 내려가요. 비광은 그래서 양날의 검.`,
    cardIds: ['01-gwang', '03-gwang', '08-gwang'],
    note: `Including the Rain bright (비광 · 12月) reduces it to ${SCORING.brights.threeWithRain}.`,
    noteKo: `비광이 포함되면 ${SCORING.brights.threeWithRain}점으로 내려가요.`,
  },
  {
    id: 'godori',
    labelKo: '고도리',
