...
export function YutBoardDemo() {
  ...
  const [pendingShortcut, setPendingShortcut] =
    useState<ShortcutOption | null>(null);
  ...
  const currentStation =
    history.length === 0 ? "start" : history[history.length - 1];
