...
const YUTNORI_SECTIONS: ReadonlyArray<Section> = [
  ...
  },
  {
    ...
    blurbKo: '십자 모양의 말판에 29개의 자리. 모서리의 지름길을 거치면 더 빨리 도착할 수 있어요.',
  },
  {
    id: 'yut-flow',
    num: '03',
    ...
    blurbKo: '윷을 던지고, 말을 옮기고, 다음 사람에게 넘겨요. 윷·모는 한 번 더 던질 수 있어요.',
  },
  {
    id: 'yut-strategy',
    num: '04',
  ...
  },
  {
    ...
    label: 'How to win',
    labelKo: '이기는 법',
    blurb: 'Get all four of your pieces around the board and back to the start.',
    blurbKo: '내 말 4개를 모두 한 바퀴 돌려 출발점으로 무사히 돌려보내면 승리.',
  },
];
